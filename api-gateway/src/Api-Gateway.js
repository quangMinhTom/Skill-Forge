...
const services = [
    ...
    { route: '/skill', target: 'http://localhost:9001/api/v1/skill', isProtected: true },
    { route: '/sub-skill', target: 'http://localhost:9002/api/v1/skill/sub-skill', isProtected: true },
];
